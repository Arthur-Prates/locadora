            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="#" method="post">
                        ...
                        <div class="mb-3">
                            <input type="text" value="<?php echo $idLocar ?>" hidden="hidden" name="idLocarUpdate">
                            ...
                            <select class="form-select form-select-md mb-3" aria-label="Large select example"
                                ...
                                foreach ($cl as $clientess) {
                                    ...
                                    if ($nomeCl === $nomeclienteLocar) {
                                        ?>
                                        <option selected value="<?php echo $idCl ?>"><?php echo $nomeCl ?></option>
                                        <?php
                                    } else {
                            ...
                            <select class="form-select form-select-md mb-3" aria-label="Large select example"
                                ...
                                foreach ($film as $films) {
                                    ...
                                    if ($nomeFilm === $nomefilmeLocar) {
                                        ?>
                                        <option selected value="<?php echo $idFilm ?>"><?php echo $nomeFilm ?></option>
                                        <?php
                                    } else {
